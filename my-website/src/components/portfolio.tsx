                ...
                <div className="flex flex-col lg:flex-row justify-between">
                    ...
                    <div className="space-y-24">
                        {portfolio.map((portfolio: ExperienceDetail) => (
                            <div className="flex space-x-6 rounded bg-gray-700 p-8" key={portfolio.id}>
                                <h1 className="font-normal text-gray-700 text-3xl md:text-4xl text-white">0{portfolio.id}</h1>
